...
function M.get()
  if M._keys then
    ...
    M._keys =  {
      ...
      { "]]", function() Utils.lsp.words.jump(vim.v.count1) end, has = "documentHighlight",
        desc = "Next Reference", cond = function() return Utils.lsp.words.enabled end },
      { "[[", function() Utils.lsp.words.jump(-vim.v.count1) end, has = "documentHighlight",
        desc = "Prev Reference", cond = function() return Utils.lsp.words.enabled end },
    }
