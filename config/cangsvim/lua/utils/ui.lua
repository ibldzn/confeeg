...
function M.foldtext()
  ...
  table.insert(ret, { " " .. CangsVim.config.icons.misc.dots })
...
function M.statuscolumn()
  ...
  local show_open_folds = vim.g.cangsvim_statuscolumn and vim.g.cangsvim_statuscolumn.folds_open
  local use_githl = vim.g.cangsvim_statuscolumn and vim.g.cangsvim_statuscolumn.folds_githl
  ...
  if show_signs then
    ...
    vim.api.nvim_win_call(win, function()
      ...
      elseif
        show_open_folds
        and not CangsVim.ui.skip_foldexpr[buf]
